...
inner join 
(	Select ultima_carga.*,obs.value_numeric valor_carga
	from
	...
	where 	obs.voided=0 and obs.concept_id=856 and obs.location_id=:location  and obs.value_numeric>=1000 and datediff(:endDate,ultima_carga.data_carga)/30>3		
